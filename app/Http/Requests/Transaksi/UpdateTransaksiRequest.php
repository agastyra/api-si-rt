...
class UpdateTransaksiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "transaksi_detail.*.periode_tahun" => ["required", "digits:4", "integer", "min:1900", "max:" . date('Y')],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            "transaksi_detail.*.tipe_transaksi_id.required" => "Tipe transaksi harus diisi",
            "transaksi_detail.*.tipe_transaksi_id.exists" => "Tipe transaksi tidak ditemukan",
